...
GO
CREATE OR ALTER PROCEDURE [dbo].[sp_InsertCMM] @control varchar(255), @valor varchar(255), @referencia varchar(255), @referenciaId int, @usuarioId int, @id int OUTPUT
AS
BEGIN
