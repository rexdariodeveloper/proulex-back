...
(
	SELECT
		...
		FORMAT(fechaPago,'dd/MM/yyyy HH:mm:ss') AS fecha,
	...
	INNER JOIN (
		...
		GROUP BY id, codigo, fechaPago, estatusId, sucursalCorteCajaId, medioPagoPVId, referenciaPago, montoDescuento, montoTotal, detallePadreId, detallePadreArticuloId, detallePadreMontoCurso, detallePadreMontoOtros
