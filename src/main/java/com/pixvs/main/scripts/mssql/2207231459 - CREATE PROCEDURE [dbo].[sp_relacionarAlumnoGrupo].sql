	...
	BEGIN
		...
		BEGIN TRY
			...
			FROM [dbo].[ProgramasGrupos] 
				LEFT JOIN [dbo].[Articulos] ON [PROGRU_PROGI_ProgramaIdiomaId] = [ART_PROGI_ProgramaIdiomaId] AND [PROGRU_PAMOD_ModalidadId] = [ART_PAMOD_ModalidadId]
			...
			BEGIN
				INSERT INTO [dbo].[Inscripciones]
				 ...
				 VALUES
					   (@codigoInscripcion, @ovId, @alumnoId, @grupoId, @origenId, CASE @esApertura WHEN 1 THEN 2000510 ELSE 2000511 END, 0, @centroId, @carreraId, GETDATE(), @creadoPorId);
			END
