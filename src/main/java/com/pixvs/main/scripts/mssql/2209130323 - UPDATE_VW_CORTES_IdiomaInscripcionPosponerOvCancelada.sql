...
(
	...
	INNER JOIN (
		...
		FROM (
			...
			LEFT JOIN Inscripciones ON DetallePadre.OVD_OrdenVentaDetalleId = INS_OVD_OrdenVentaDetalleId
...
(
	...
	FROM
		[dbo].[VW_CORTES] vw
		LEFT JOIN ProgramasGrupos on vw.grupoOriginalId = PROGRU_GrupoId
