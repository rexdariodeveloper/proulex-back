/**
* Created by Angel Daniel Hernández Silva on 15/12/2021.
...
CREATE OR ALTER VIEW [dbo].[VW_CardProjection_ProgramasGrupos] AS
	...
	WHERE
        DATEADD(DAY,PAMOD_DiasFinPeriodoInscripcion,PROGRU_FechaInicio) >= GETDATE()
		AND PROGRU_FechaFin > GETDATE()
        AND PROGRU_Activo = 1
	GROUP BY PROGRU_GrupoId, PROG_Codigo, CMM_Valor, PAMOD_Nombre, PROGRU_Nivel, PROGRU_Grupo, PROGRU_FechaInicio, PROGRU_FechaFin, PAMODH_Horario, PAMOD_Color, ART_ArticuloId, PROGRU_Nivel, PROGI_CMM_Idioma, PROG_ProgramaId, PAMOD_ModalidadId, PROGRU_Cupo, PROGRU_Multisede, SUC_SucursalId, SUC_Nombre
