...
AS BEGIN
	...
	FROM(
		...
		/*************************************************/
		/***** Deducciones por cancelación de clases *****/
		/*****vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*****/

		SELECT * FROM [dbo].[fn_getPrenominaDeduccionesCancelacionClases] (@fechaInicioQuincena,@fechaFinQuincena)
		...
		SELECT * FROM [dbo].[fn_getPrenominaApoyoTransporte] (@fechaInicioQuincena,@fechaFinQuincena)
