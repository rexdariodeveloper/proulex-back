CREATE OR ALTER VIEW [dbo].[VW_CXPFacturas] AS
SELECT CXPF_CXPFacturaId AS id, 
	CXPF_CodigoRegistro AS folio,
	CONVERT(DATE, CXPF_FechaRegistro) as fechaFactura, CONVERT(DATE, DATEADD(DAY,CXPF_DiasCredito,CXPF_FechaRegistro)) AS fechaVencimiento ,	
	CXPF_CMM_TipoRegistroId as idTipoRegistro, cmm_tr.CMM_Valor as tipoRegistro,
	CXPF_CMM_TipoRegistroId as idTipoPago, cmm_tp.CMM_Valor as tipoPago,
	CXPF_CMM_TipoRegistroId as idEstatus, cmm_es.CMM_Valor as estatus,
