...
CREATE OR ALTER VIEW [dbo].[VW_AlumnosGruposValesCertificaciones]
AS
	...
	WHERE ag.ALUG_CMM_EstatusId = 2000675 AND pg.PROGRU_CMM_EstatusId = 2000621
	GROUP BY ag.ALUG_AlumnoGrupoId, a.ALU_Codigo, a.ALU_Nombre, a.ALU_PrimerApellido, a.ALU_SegundoApellido, s.SUC_Nombre, p.PROG_Codigo, idioma.CMM_Valor, pg.PROGRU_Nivel, certificacion.NombreArticulo, picdd.PICDD_PorcentajeDescuento, pg.PROGRU_FechaFin, certificacion.CostoUltimo, pg.PROGRU_PROGI_ProgramaIdiomaId, s.SUC_SucursalId, pam.PAMOD_ModalidadId, pg.PROGRU_FechaInicio, picd.PICD_ProgramaIdiomaCertificacionDescuentoId
GO