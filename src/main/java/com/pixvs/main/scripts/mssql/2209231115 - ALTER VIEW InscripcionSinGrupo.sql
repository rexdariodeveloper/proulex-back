...
-- Modified by: Rene Carrillo
-- Modify date: 22/09/2022
-- Description:	Vista para obtener el listado de alumnos sin grupo
-- ================================================

ALTER   VIEW [dbo].[VW_ListadoProjection_InscripcionesSinGrupo] AS
