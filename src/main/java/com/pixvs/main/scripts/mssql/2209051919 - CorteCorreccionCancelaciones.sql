DELETE FROM SucursalesCortesCajas WHERE SCC_SucursalCorteCajaId IN(1111, 1423, 1424)
GO
...
(
	...
	INNER JOIN (
		...
		GROUP BY id, codigo, fecha, fechaPago, estatusId, sucursalCorteCajaId, medioPagoPVId, referenciaPago, montoDescuento, montoTotal, detallePadreId, detallePadreArticuloId, detallePadreMontoCurso, detallePadreMontoOtros, folioFactura, esCurso, fechaCreacion, descuentoDetalle, totalDetalle
