CREATE UNIQUE INDEX IX_TAB_DetalleTabuladores ON TabuladoresDetalles(TABD_TAB_TabuladorId, TABD_PAPC_ProfesorCategoriaId)
WHERE TABD_Activo = 1
GO
...
AS
    ...
    SELECT @stmt = '
        ...
        INNER JOIN PAProfesoresCategorias PAPC ON PAPC.PAPC_ProfesorCategoriaId = TD.TABD_PAPC_ProfesorCategoriaId
