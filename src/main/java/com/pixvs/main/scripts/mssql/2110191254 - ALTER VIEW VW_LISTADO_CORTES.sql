...
* Object:  ALTER VIEW [dbo].[VW_LISTADO_CORTES]
*/
...
(
	...
	FROM(
		...
		GROUP BY SCC_SucursalCorteCajaId, SCC_SUC_SucursalId, SCC_SP_SucursalPlantelId, SCC_USU_UsuarioAbreId, SCC_FechaInicio, SCC_FechaFin
	) Cortes
