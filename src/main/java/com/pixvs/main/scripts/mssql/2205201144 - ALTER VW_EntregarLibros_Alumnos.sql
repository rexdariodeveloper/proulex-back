CREATE OR ALTER VIEW [dbo].[VW_EntregarLibros_Alumnos] AS
	...
	GROUP BY 
		...
		PROGRU_Codigo, EstatusInscripcion.CMM_ControlId, EstatusInscripcion.CMM_Valor, SUC_SucursalId, ALU_CodigoUDG,
        INS_InscripcionId, OV_OrdenVentaId, OV_Codigo
	...
	GROUP BY 
		...
		EstatusInscripcion.CMM_ControlId, EstatusInscripcion.CMM_Valor, SUC_SucursalId, ALU_CodigoUDG,
        INSSG_InscripcionId, OV_OrdenVentaId, OV_Codigo
