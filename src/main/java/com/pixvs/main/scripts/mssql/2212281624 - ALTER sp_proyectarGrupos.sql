/****** Object:  StoredProcedure [dbo].[sp_proyectarGrupos]    Script Date: 28/12/2022 04:10:25 p. m. ******/
SET ANSI_NULLS ON
GO
...
BEGIN
		...
		IF OBJECT_ID('tempdb..#tmpOV') IS NOT NULL
         ...
         SELECT PROGRU_SUC_SucursalId,
                ...
                id_programacion_academica AS PROGRU_PAC_ProgramacionAcademicaComercialId,
                inicio fechaInicio,
                fin fechaFin,
         ...
         FROM dbo.ProgramasGrupos
			  ...
			  (
					SELECT TOP 1
							...
							PACD_PAC_ProgramacionAcademicaComercialId AS id_programacion_academica
