...
([ART_CodigoArticulo],[ART_NombreArticulo],[ART_Descripcion],
 ...
 [ART_ACAT_CategoriaId],[ART_ARTT_TipoArticuloId],[ART_ARTST_ArticuloSubtipoId],[ART_UM_UnidadMedidaInventarioId],
 [ART_CMM_TipoCostoId],[ART_CostoUltimo],[ART_CostoPromedio],[ART_CostoEstandar],[ART_Activo],[ART_FechaCreacion],
 [ART_Inventariable],[ART_ArticuloParaVenta])
Select 
...
(Select ARTT_ArticuloTipoId from ArticulosTipos where ARTT_Descripcion='Misceláneo') as tipoArticulo,
(Select ARTST_ArticuloSubtipoId from ArticulosSubtipos where ARTST_Descripcion='Certificación') as subTipo,
