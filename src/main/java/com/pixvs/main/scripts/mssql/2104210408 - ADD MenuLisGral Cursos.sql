INSERT INTO [dbo].[MenuListadosGenerales]
     ...
     VALUES
		   ...
		   'Formato de examen','Test Format',1,'list',1,1000082,'ControlesMaestrosMultiples','CMM_CUR_TestFormat',1,'/api/v1/cmm',GETDATE())
GO
...
INSERT INTO [dbo].[MenuListadosGeneralesDetalles]
     ...
     VALUES
           ((SELECT MLG_ListadoGeneralNodoId from MenuListadosGenerales where MLG_Titulo='Formato de examen')
