...
-- Create date: ------
-- Modify date: 10/10/2022
-- Description:	La vista de Pago a Proveedores Projection CXPFactura
-- Version 1.0.1
-- =============================================


ALTER   VIEW [dbo].[VW_PAGO_PROVEEDORES_PROJECTION_CXPFactura] AS
...
SELECT
   ...
   CXPF_ARC_FacturaPDFId as facturaPDFId,
   CXPF_ARC_FacturaXMLId as facturaXMLId
FROM CXPFacturas
LEFT JOIN (
	SELECT
