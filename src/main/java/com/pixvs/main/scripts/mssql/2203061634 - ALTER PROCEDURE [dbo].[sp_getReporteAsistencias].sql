...
/**
	param @sedeId		INT			[Requerido]	Id de la sede (sucursal)
	param @plantelId	INT			[Opcional]	Id del plantel
	param @pacId		INT			[Opcional*]	Id de la programación academica comercial
	param @cicloId		INT			[Opcional*]	Id del ciclo escolar
	param @modalidadId	INT			[Requerido]	Id de la modalidad
	param @fechaInicio	DATE		[Requerido]	Fecha de inicio de curso
	param @codigoCurso	NVARCHAR	[Opcional]	Codigo del curso
	param @usuarioId	INT			[Requerido] Id del usuario que consulta
**/
SET ANSI_NULLS ON
GO
