...
CREATE FUNCTION [dbo].[fn_reporteAntiguedadSaldosResumen] (@proveedoresIds varchar(max), @facturasIds varchar(max), @monedaId int, @diasAgrupados int, @mostrarVencidos bit, @mostrarPorVencer bit)
