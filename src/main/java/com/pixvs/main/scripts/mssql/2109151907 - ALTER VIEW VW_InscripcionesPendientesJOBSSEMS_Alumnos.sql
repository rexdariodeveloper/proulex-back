/**
* Created by Angel Daniel Hernández Silva on 15/09/2021.
* Object:  ALTER VIEW [dbo].[VW_InscripcionesPendientesJOBSSEMS_Alumnos]
*/

ALTER TABLE [dbo].[ProgramasGrupos] ADD [PROGRU_Codigo] [varchar](25) NULL
GO

UPDATE [dbo].[ProgramasGrupos] SET [PROGRU_Codigo] = [grupoCodigo]
FROM [dbo].[ProgramasGrupos]
INNER JOIN [dbo].[VW_Codigo_ProgramasGrupos] ON [grupoId] = [PROGRU_GrupoId]
GO

ALTER TABLE [dbo].[ProgramasGrupos] ALTER COLUMN [PROGRU_Codigo] [varchar](25) NOT NULL
GO
...
CREATE OR ALTER VIEW [dbo].[VW_InscripcionesPendientesJOBSSEMS_Alumnos] WITH SCHEMABINDING AS
    ...
    INNER JOIN [dbo].[OrdenesVentaDetalles] ON OVD_OrdenVentaDetalleId = INS_OVD_OrdenVentaId
