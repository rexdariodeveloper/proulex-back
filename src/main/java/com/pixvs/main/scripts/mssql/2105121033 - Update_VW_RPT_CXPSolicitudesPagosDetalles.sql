...
LEFT JOIN (
	...
	SELECT cxpf.codigoProveedor, cxpf.nombreProveedor, cxpf.proveedorRFC, CXPSD_CXPS_CXPSolicitudPagoId, cmm_es.CMM_Valor as detalleEstatus, cmm_es.CMM_ControlId as detalleEstatusId,
		COALESCE(srv.sucursalDetalle, oc.sucursalDetalle,PagosRh.sucursal, '-') as sucursalDetalle,
	...
	LEFT JOIN (
		SELECT distinct CXPFD_CXPF_CXPFacturaId, OC_Codigo as folio, SUC_Nombre as sucursalDetalle
