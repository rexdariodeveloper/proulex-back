/**
* Created by Angel Daniel Hernández Silva on 01/06/2022.
*/
SET ANSI_NULLS ON
GO
...
TODO: verificar horasDeducción con varios cambios de profesor

declare @fechaInicioQuincena Date = '2022-06-16', @fechaFinQuincena Date = '2022-06-30';
	...
	SELECT
        ...
        horas * -1 AS horasPagadas,
        FORMAT(0, 'C', 'en-us') AS percepcion,
        FORMAT(sueldo * horasDeduccion, 'C', 'en-us') AS deduccion,
        CMM_Valor AS idioma,
        NULL AS fechaDiaFestivo,
        NULL AS fechaDiaSuplida,
        PROGRU_CategoriaProfesor AS categoria,
