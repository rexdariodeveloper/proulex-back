...
DROP VIEW [dbo].[RPT_ALUMNOS_PAGOS]
GO

CREATE OR ALTER VIEW [dbo].[VW_RPT_ALUMNOS_PAGOS]
AS
select 
	...
	case when PROG_JOBSSEMS = 1 then null else SUC_Nombre end sede,
	SP_Nombre escuela,
	OV_ReferenciaPago referencia,
...
left join Sucursales on PROGRU_SUC_SucursalId = SUC_SucursalId
GO