/**
* Created by Angel Daniel Hernández Silva on 13/08/2021.
...
CREATE OR ALTER VIEW [dbo].[VW_ListadoProjection_InscripcionesSinGrupo] AS
	...
	SELECT
		...
		INSSG_OVD_OrdenVentaId AS ordenVentaDetalleId,
		...
		INSSG_SUC_SucursalId AS sucursalId
	...
	INNER JOIN OrdenesVentaDetalles ON OVD_OrdenVentaDetalleId = INSSG_OVD_OrdenVentaId
