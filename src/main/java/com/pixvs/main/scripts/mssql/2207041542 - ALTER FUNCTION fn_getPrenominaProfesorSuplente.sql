/**
* Created by Angel Daniel Hernández Silva on 29/06/2022.
*/
SET ANSI_NULLS ON
GO
...
AS BEGIN
	...
	INNER JOIN VW_GRUPOS_HORARIOS ON grupoId = PROGRULC_PROGRU_GrupoId AND dia = DATEPART(WEEKDAY,PROGRULC_Fecha)
