...
ALTER COLUMN PROGRU_Grupo INT not null
GO
...
AS
	Select 
		...
		CONCAT(SUBSTRING(SUC_CodigoSucursal, 1, 3),SUBSTRING(PROG_Codigo, 1, 3),SUBSTRING(CMM_Referencia, 1, 3),SUBSTRING(PAMOD_Codigo, 1, 3),FORMAT(PROGRU_Nivel,'00'),PAMODH_Codigo,FORMAT(PROGRU_Grupo,'00')) as codigo,
