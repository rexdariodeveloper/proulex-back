...
(
	...
	FROM 
		OrdenesVenta
		INNER JOIN OrdenesVentaDetalles padre on OV_OrdenVentaId = padre.OVD_OV_OrdenVentaId
	...
	GROUP BY
		OV_Codigo, OV_MPPV_MedioPagoPVId, OV_ReferenciaPago, OV_FechaModificacion, OV_FechaCreacion, OV_CMM_EstatusId, OV_SCC_SucursalCorteCajaId, padre.OVD_OrdenVentaDetalleId, padre.OVD_ART_ArticuloId
	) ovs
