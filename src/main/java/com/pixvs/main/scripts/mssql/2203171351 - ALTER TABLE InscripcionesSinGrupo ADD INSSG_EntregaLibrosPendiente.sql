/**
* Created by Angel Daniel Hernández Silva on 16/03/2022.
* Object:  ALTER VIEW [dbo].[VW_EntregarLibros_Alumnos]
*/

ALTER TABLE [dbo].[InscripcionesSinGrupo] ADD [INSSG_EntregaLibrosPendiente] [bit] NULL
GO

UPDATE InscripcionesSinGrupo SET INSSG_EntregaLibrosPendiente = CAST(0 AS bit)
GO

ALTER TABLE [dbo].[InscripcionesSinGrupo] ALTER COLUMN [INSSG_EntregaLibrosPendiente] [bit] NOT NULL
GO
