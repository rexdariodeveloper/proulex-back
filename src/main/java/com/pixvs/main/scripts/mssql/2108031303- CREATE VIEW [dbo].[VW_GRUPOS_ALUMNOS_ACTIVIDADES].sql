CREATE OR ALTER VIEW [dbo].[VW_GRUPOS_ALUMNOS_ACTIVIDADES]
AS
	SELECT
		...
		PAMOD_Color color,
		PAC_Codigo programacionCodigo,
		PAC_Nombre programacionNombre,
	...
	FROM
		...
		INNER JOIN ProgramacionAcademicaComercial ON PROGRU_PAC_ProgramacionAcademicaComercialId = PAC_ProgramacionAcademicaComercialId
