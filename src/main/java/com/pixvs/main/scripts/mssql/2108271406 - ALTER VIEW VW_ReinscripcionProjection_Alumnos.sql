/**
* Created by Angel Daniel Hernández Silva on 26/08/2021.
...
CREATE OR ALTER VIEW [dbo].[VW_ReinscripcionProjection_Alumnos] AS
	...
	LEFT JOIN VW_ALUMNOS_GRUPOS_FALTAS AS Faltas ON Faltas.alumnoId = AlumnosListosReinscripcion.alumnoId AND Faltas.grupoId =  PROGRU_GrupoId
	LEFT JOIN BecasUDG
