...
import com.pixvs.main.models.projections.RequisicionPartida.RequisicionPartidaEditarProjection;
...
public interface RequisicionEditarProjection {
    ...
    UsuarioComboProjection getEnviadaPor();

    UsuarioComboProjection getCreadoPor();
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss.SSSSSSS", timezone = "America/Mexico_City")
    Date getFechaModificacion();

    List<RequisicionPartidaEditarProjection> getPartidas();
